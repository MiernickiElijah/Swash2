...
function Projects () {
    return(
        ...
        </video><main className="animate__animated animate__fadeInLeft">
                    ...
                    <section id="deck">
                        ...
                        <article className="container col-xxl-8 px-4 py-5">
                            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div className="col-lg-6">
                                    <h1 className="display-5 fw-bold lh-1 mb-3"><a className="projectHead"
                                        href="https://poggers-pog.herokuapp.com/login" target="_blank" rel="noreferrer"></a></h1>
                            ...
                            <div class="col-10 col-sm-8 col-lg-6">
                                <img class="d-block mx-lg-auto img-fluid pics"
                                    src={poggers} alt=""></img></div></a>
                        ...
                        <article className="container col-xxl-8 px-4 py-5">
                            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div className="col-lg-6">
                                    <h1 className="display-5 fw-bold lh-1 mb-3"><a className="projectHead"
                                        href="https://miernickielijah.github.io/Druid/" target="_blank" rel="noreferrer"></a></h1>
                        ...
                        <figcaption>photo by Johannes Plenio on Unsplash</figcaption>
                            <a href="https://miernickielijah.github.io/Druid/" target="_blank" rel="noreferrer"></a>
                            </div>
                        </article>
                        ...
                        <article className="container col-xxl-8 px-4 py-5">
                            <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                                <div className="col-lg-6">
                                    <h1 className="display-5 fw-bold lh-1 mb-3"><a className="projectHead"
                                        href="https://miernickielijah.github.io/barbarian/" target="_blank" rel="noreferrer"></a></h1>
                            ...
                            <a href="https://miernickielijah.github.io/barbarian/" target="_blank" rel="noreferrer"></a>
                            </div>
