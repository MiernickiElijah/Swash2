    ...
    <>
       <div className="overlay"></div><video id="vid" playsInline autoPlay muted loop>
        ...
        <div class="page" data-page="3">
            <section id="deck">
                {/* <!--P4--> */}
                <article class="container col-xxl-8 px-4 py-5">
                    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                        <div class="col-lg-6">
                            <h1 class="display-5 fw-bold lh-1 mb-3"><a class="projectHead"
                ...
                <article class="container col-xxl-8 px-4 py-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="lead">This is a random character generator for 5th edition dungeons and
                            dragons.
                            (HTML,
                            APIs, CSS, vanilla
                ...
                <article class="container col-xxl-8 px-4 py-5">
                    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                        <div class="col-lg-6">
                            ...
                            <p class="lead">This is a live weather dashboard with current and 5 day forecast based on US
                                city.
                                (HTML, CSS, HTML,
                ...
                <article class="container col-xxl-8 px-4 py-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="lead">This is a README.md generator using node.js. Allowing a user to create an entire
                ...
                <article class="container col-xxl-8 px-4 py-5">
                    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                        <div class="col-lg-6">
                            ...
                            <p class="lead">This is a day scheduler that allows users to save written notes via time to
                                their
                                local computer and
